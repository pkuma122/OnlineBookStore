  ...
  <body> 
   ...
   <center>
    <table class="textStyle">
     <tr bgcolor="orange">
      <td align="center" colspan="3"><font size="5"><b>Personal Details</b></font></td>
     </tr>
     <core:if test="${updateError ne null}">
     <tr bgcolor="lightyellow">
      <td align="center" colspan="3"><font size="4" color="red"><b>${updateError}</b></font></td>
     </tr>
     </core:if>
      <tr bgcolor="#fdeaff">
       <td><font size="3"><b>Nname</b></font></td>
       <td colspan="2"><font size="3"><b>${USER_TO.firstName} ${USER_TO.middleName} ${USER_TO.lastName}</b></font></td>
      </tr>
      <tr bgcolor="#dee1fe">
       <td><font size="3"><b>Email</b></font></td>
       <td><core:if test="${EDIT_INFO eq null}"><font size="3"><b>${USER_TO.email}</b></font></core:if>
           <core:if test="${EDIT_INFO ne null}">
           <input type="text" value="${EMAIL}" name="email" size="25" style="color: black;background-color: #b4e0d2;"/>
           <font color="red" size="4"><b><jlc:error property="email"/></b></font></core:if>
       </td>
      </tr>
      <tr bgcolor="#e1ffde">
       <td><font size="3"><b>Phone</b></font></td>
       <td><core:if test="${EDIT_INFO eq null}"><font size="3"><b>${USER_TO.phone}</b></font></core:if>
           <core:if test="${EDIT_INFO ne null}">
           <input type="text" value="${PHONE}" name="phone" size="25" style="color: black;background-color: #b4e0d2;"/>
           <font color="red" size="4"><b><jlc:error property="phone"/></b></font></core:if>
       </td>
      </tr>
      <tr bgcolor="#fdeaff">
      ...
      <tr bgcolor="maroon">
       ...
       <td align="center" colspan="3"><a href="editinfo.jlc"><font size="4"><b>Edit</b></font></a></td>
       </core:if>
       <core:if test="${EDIT_INFO ne null}">
       <td align="center"><a href="cancleedit.jlc"><font size="4"><b>Cancel</b></font></a></td>
       <td align="center"><input type="submit" value="Update" class="signoutButton"/></td>
       </core:if>
      </tr>
  </table>
  </center>
