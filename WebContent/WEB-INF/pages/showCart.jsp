...
<tr bgcolor="lightyellow">
<td align="center" colspan="8">
<b><font size="4">${REMOVED_BOOK.bookName }</font><font
color="red" size="4"> is removed successfully. Quantity was </font><font color="green" size="4">${REMOVED_BOOK.selectedNumberOfBook}</font> </b>
</td>
</tr>
</core:if>
<tr bgcolor="black">
...
<jlc:displayBookTotalAmount value="${bto.cost * bto.selectedNumberOfBook }" quantity="${bto.selectedNumberOfBook}" />/-</font>
</td></tr>
</core:forEach>
<tr bgcolor="#ff8080">
