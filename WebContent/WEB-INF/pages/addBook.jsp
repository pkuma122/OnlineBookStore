 ...
 <form action="addBook.jlc" method="post">
   <center>
    <table class="textStyle" height="95%">
     <tr bgcolor="orange">
      <td align="center" colspan="7"><font size="5"><b>Add Book Information</b></font></td>
     </tr>
     <tr bgcolor="lightyellow">
      <td align="center" colspan="3"><font size="4" color="red"><b><jlc:error property="addingBookError"/> </b></font></td>
     </tr>
    <core:if test="${SHOW_ADD_BOOK ne 'OK'}">
     <tr>
      ...
      <td><font size="4" color="red"><b><jlc:error property="bname"/></b></font></td>
     </tr>
     <tr>
      <td align="center" height=""><font size="5"><b>Author</b></font></td>
      <td><input type="text" size="35" style="color: black; background-color: #b4e0d2; font-size: 20" name="author"></td>
      <td><font size="4" color="red"><b><jlc:error property="author"/></b></font></td>
     </tr>
     <tr>
      <td align="center" height=""><font size="5"><b>Cost</b></font></td>
      <td><input type="text" size="35" style="color: black; background-color: #b4e0d2; font-size: 20" name="cost"></td>
      <td><font size="4" color="red"><b><jlc:error property="cost"/></b></font></td>
     </tr>
     <tr>
      <td align="center" height=""><font size="5"><b>Publication</b></font></td>
      <td><input type="text" size="35" style="color: black; background-color: #b4e0d2; font-size: 20" name="publication"></td>
      <td><font size="4" color="red"><b><jlc:error property="publication"/></b></font></td>
     </tr>
     <tr>
      <td align="center" height=""><font size="5"><b>Edition</b></font></td>
       <td>
     ...
     <tr>
      <td align="center" colspan="3">
       ...
       <input type="submit" value="Clear" style="color: white; background-color: maroon; font-size: 17">
      </td>
     </tr>
    </core:if> 
  </table> 
