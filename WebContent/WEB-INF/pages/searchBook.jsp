...
<html>
  ...
  <body>
    <form action="searchBook.jlc" method="post">
     <center>
      <table height="95%" class="textStyle">
       <tr bgcolor="orange">
        <td align="center" colspan="7"><font size="5"><b>Search Book</b></font></td>
       </tr>
       <core:if test="${searchingBookError ne null}">
        <tr bgcolor="lightyellow">
         <td align="center" colspan="6"><font color="red" size="4"><b><jlc:error property="searchingBookError"/></b></font></td>
        </tr>
       </core:if>
       <tr valign="top">
        ...
        <td align="center"><jlc:showEdition/></td>
       </tr>
       <tr> 
   ...
   <core:if test="${BOOK_LIST ne null}">
    <form action="sortInfo.jlc" method="post">
     <table width="90%">
      <tr>
       ...
       <td align="left"><font color="red" size="4"><jlc:error property="sortingError"/></font></td> 
    ...
    <table width="90%" cellspacing="0" cellpadding="3" style="font-family: arial">
     ...
     <tr>
      <td colspan="7" align="center" bgcolor="lightyellow"> <font color="red" size="4"><b>${REMOVED_TOTAL}</b></font>
      </td>
     </tr> 
     </core:if>
     <tr bgcolor="black">
      ...
      <core:if test="${SELECTED_BOOK_LIST ne null}">
       <td bgcolor="maroon" align="center">
        <a href="showCartDef.jsp"><font color="yellow" size="5"><b>Show My Cart</b></font></a>
       </td>
      </core:if>
     </tr>  
     <%
     ...
     <core:forEach var="bto" items="${BOOK_LIST}">
       ...
       <tr bgcolor="<%=color%>">
        ...
        <td><font size="4" face="Rupee Foradian"></font><font size="4">${bto.cost}/-</font></td>
        <td align="center">
