  ...
  <center><br/>
   <table align="center" width="80%" class="textStyle" cellspacing="0">
    <core:if test="${ORDER_FOUND eq null}">
     <tr bgcolor="orange">
      <td align="center"><font color="black" size="5"><b>Order Information not found </b></font></td>
     </tr>
    </core:if>
    <core:if test="${ORDER_FOUND ne null}">
     <tr bgcolor="orange">
      <td align="center" colspan="6"><font color="black" size="5"><b>Order Information </b></font></td>
     </tr>
     <tr bgcolor="black">
     ...
     <core:forEach var="oto" items="${ORDER_FOUND}">
      ...
      <tr bgcolor="<%=color%>">
       ...
       <td align="center"><font size="3" face="Rupee Foradian"></font><font size="3"><b>${oto.totalAmount}/-</b></font></td>
   ...
   <table width="95%" class="textStyle" cellspacing="0">
    <tr bgcolor="maroon">
     <td align="center" colspan="7">
      <font color="yellow" size="4"><b>Information about the order with id
      <font color="white">${ORDER_TO.orderId}</font></b></font>
     </td>
    </tr>
    <tr bgcolor="black">
    ...
    <core:forEach var="bto" items="${ORDER_TO.orderItemList}">
     ...
     %>
      <tr bgcolor="<%=color%>">
       ...
       <td align="right"><font size="4" face="Rupee Foradian"></font><font size="4"><jlc:displayBookTotalAmount 
           value="${bto.cost * bto.selectedNumberOfBook}" quantity="${bto.selectedNumberOfBook}"/>/-</font>
       </td>
      </tr>   
    </core:forEach>
   </table>
